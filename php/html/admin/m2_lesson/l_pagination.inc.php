    ...
    <div class="col-sm-12 col-md-7">
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-end">
                <?php if ($page > 1) : ?>
                    <li class="page-item">
                        <a class="page-link" href="?active=lesson&lesson&page=<?= $page - 1 ?>" tabindex="-1" aria-disabled="true">ก่อนหน้า</a>
                    </li>
                <?php else : ?>
                ...
                <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
                    <li class="page-item <?= ($i == $page) ? 'active' : '' ?>">
                        <a class="page-link" href="?active=lesson&lesson&page=<?= $i ?>">
                            <?= $i ?>
                            <?php if ($i == $page) : ?>
                ...
                <?php if ($page < $total_pages) : ?>
                    <li class="page-item">
                        <a class="page-link" href="?active=lesson&lesson&page=<?= $page + 1 ?>">ถัดไป</a>
                    </li>
                <?php else : ?>
                    <li class="page-item disabled">
